    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(requestRegistry -> requestRegistry                  
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/appointments/{hospital_Id}/{appointment_Id}/accept").hasAuthority(Role.PATIENT.name())
                        .requestMatchers(HttpMethod.PATCH, "/appointments/{hospital_Id}/{appointment_Id}/cancel").hasAuthority(Role.PATIENT.name())
