    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(requestRegistry -> requestRegistry                  
                        ...
                        .requestMatchers(HttpMethod.POST, "/auth/forgotten_password").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/staff/{hospital_Id}/consultant-specialties").hasAuthority(Role.PATIENT.name())
                        .requestMatchers(HttpMethod.POST, "/staff/{hospital_Id}/consultants").hasAuthority(Role.PATIENT.name())
